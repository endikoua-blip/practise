      ...
      landing: {
        ...
        details: [
          ...
          },
          {
            ...
            type: 'text',
            content: '<strong>5-7 робочих днів від затвердження дизайну</strong>'
          },
          {
            icon: '🎁',
            title: 'Бонуси:',
          ...
          },
          {
            ...
            type: 'text',
            content: '<strong>Стартапів, промо-сторінок, портфоліо, презентації продукту</strong>'
          }
        ]
      },
      website: {
        ...
        details: [
          ...
          },
          {
            ...
            title: 'Терміни виконання:',
            type: 'text',
            content: '<strong>10-14 робочих днів від затвердження дизайну</strong>'
          },
          {
            icon: '🎁',
            title: 'Бонуси:',
          ...
          },
          {
            ...
            title: 'Ідеально підходить для:',
            type: 'text',
            content: '<strong>Малого бізнесу, корпоративних сайтів, інтернет-магазинів (до 50 товарів), блогів</strong>'
          }
        ]
      }
    };
